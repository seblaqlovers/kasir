...
<div class="container">
	<div class="row mt-3">
			<div class="col-sm-8"><h3>Daftar Pelanggan</h3></div>
			<div class="col-sm-4">
...
<table class="table table-hover table-bordered table-striped table-sm">
	...
	<tbody>
		...
		<tr>
				...
				<td><?= $data['no_hp'] ?></td>
				<td align="right">
					<a href="" class="btn btn-dark btn-sm" data-bs-toggle="modal" data-bs-target="#modaledit<?= $data['id_pelanggan'] ?>">Edit</a>

					<a class="btn btn-dark btn-sm" href="delete.php?id=<?= $data['id_pelanggan'] ?>" onclick="return confirm('Apakah Anda Yakin data produk <?= $data['nama_pelanggan'] ?> akan dihapus ?')" class="hapus">Delete</a>
				</td>
		</tr>
			...
			<td colspan="6" class="text-center">
				<div class="container">
					<div class="row">
						...
						<!-- tombol input	 -->
							<button type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#myModal">[+] Data Pelanggan</button>						
						</div>
...
<div class="modal fade" id="myModal">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-footer">
      	<button type="submit" class="btn btn-dark" name="save">Simpan</button>
        <button type="button" class="btn btn-darkr" data-bs-dismiss="modal">Batal</button>
      </div>
    </form>
    </div>
  </div>
