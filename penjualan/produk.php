...
<div class="container">
	<div class="row">
			<div class="col-sm-8 px-0"><h3><a href="transaksi.php" class="btn btn-dark">&laquo; Back</a> Daftar Produk</h3></div>
...
<table class="table table-hover table-striped table-sm">
	...
	<tbody>
		...
		<tr>
				<td class="px-3"><?= $no ?>.</td>
				<td><a class="btn btn-sm btn-dark" href="transaksi.php?kp=<?= $data['kode_produk'] ?>"><?= $data['kode_produk'] ?></a></td>
