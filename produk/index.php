...
<table class="table table-hover table-bordered table-striped table-sm">
	...
	<tbody>
		...
		<tr>
				...
				<td align="right">
					<a href="" class="btn btn-dark btn-sm" data-bs-toggle="modal" data-bs-target="#modaledit<?= $data['id_produk'] ?>">Edit</a>

					<a class="btn btn-dark btn-sm" href="delete.php?id=<?= $data['id_produk'] ?>" onclick="return confirm('Apakah Anda Yakin data produk <?= $data['nama_produk'] ?> akan dihapus ?')" class="hapus">Delete</a>
				</td>
		</tr>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-footer">
      	<button type="submit" class="btn btn-dak" name="save">Simpan</button>
			...
			<td colspan="6" class="text-center">
				<div class="container">
					<div class="row">
						...
						<!-- tombol input	 -->
							<button type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#myModal">[+] Data Produk</button>
							<button type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#tambahstok">[+] Stok</button>						
						</div>
