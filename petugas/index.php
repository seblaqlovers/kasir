...
<div class="container">
	<div class="row mt-3">
			<div class="col-sm-8"><h3>Daftar Petugas</h3></div>
			<div class="col-sm-4">
...
<table class="table table-hover table-striped table-sm table-bordered" >
	...
	<tbody>
		...
		<tr>
				...
				<td align="right">
					<a href="" class="btn btn-dark btn-sm" data-bs-toggle="modal" data-bs-target="#modaledit<?= $data['id_petugas'] ?>">Edit</a>

					<a class="btn btn-dark btn-sm" href="delete.php?id=<?= $data['id_petugas'] ?>" onclick="return confirm('Apakah Anda Yakin data Petugas <?= $data['nama_petugas'] ?> akan dihapus ?')" class="hapus">Delete</a>
				</td>
		</tr>
			...
			<td colspan="6" class="text-center">
				<div class="container">
					<div class="row mt-3">
						...
						<!-- tombol input	 -->
							<button type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#myModal">[+] Data Petugas</button>						
						</div>
